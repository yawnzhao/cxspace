...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '创学空间', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || ' 创新学习、学习创新', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cxspace.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '创新, 学习', // 网站关键词 英文逗号隔开
